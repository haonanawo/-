    ...
    <body>
        <div id="wrap">
            ...
            <div class="leftMeun" id="leftMeun">
                <div id="logoDiv">
                    <p id="logoP"><img id="logo" alt="左右结构项目" src="images/logo.png"><span>人力资源管理系统</span></p>
                </div>
                <div id="personInfor">
                    <p id="userName">管理员</p>
                ...
                <div class="meun-item meun-item-active" href="#sour" aria-controls="sour" role="tab" data-toggle="tab"><img src="images/icon_source.png">员工管理</div>
                <div class="meun-item" href="#chan" aria-controls="chan" role="tab" data-toggle="tab"><img src="images/icon_change_grey.png">修改密码</div>
                <div class="meun-title">正在开发~~~~~~</div>
...
<div class="col-xs-3">
                        ...
                        <form class="form-horizontal" action="NSelectServlet" method="post">
	<div class="col-xs-4">
	
                        <input type="" class="form-control input-sm" name="ename" placeholder="输入姓名搜索">
...
<c:forEach items="${list }" var="em">
                            ...
                            <div class="col-xs-2">
                               ...
                               <a href="EmployeeGetByIdServlet?eno=${em.eno }"> <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#reviseUser">修改</button></a>
                               
                                <a href="EmployeeDeleteServlet?eno=${em.eno }&username=3"><button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#deleteUser">删除</button></a>
                            </div>
                        </div>
                            ...
                            <div class="modal-body">
                                <div class="container-fluid">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-xs-8 ">
                                                <input type="" class="form-control input-sm duiqi" name="ename" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="sLink" class="col-xs-3 control-label">年龄：</label>
                                            <div class="col-xs-8 ">
                                                <input type="" class="form-control input-sm duiqi" name="eage" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="sOrd" class="col-xs-3 control-label">电话：</label>
                                            <div class="col-xs-8">
                                                <input type="" class="form-control input-sm duiqi" name="etel" placeholder="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-8">
                                                <label class="control-label" for="男">
                                                    <input type="radio" name="esex"  value="男">男</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <label class="control-label" for="女">
                                                    <input type="radio" name="esex"  value="女"> 女</label>
                                            </div>
                                        </div>
...
<form class="form-horizontal" action="UserUpdateServlet" method="post">
         <c:forEach items="${ulist }" var="us">
                        <div class="form-group">
                            ...
                            <div class="col-xs-5">
                                <input type="" name="uname" value="${us.uname }" readonly="readonly" class="form-control input-sm duiqi" style="margin-top: 7px;">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="sKnot" class="col-xs-4 control-label">密码：</label>
                            <div class="col-xs-5">
                                <input type="" name="upass" value="${us.upass }" readonly="readonly" class="form-control input-sm duiqi"  style="margin-top: 7px;">
                            </div>
                        </div>
          </c:forEach>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-5">
                                <input type="" name="npass" class="form-control input-sm duiqi" id="sKnot" placeholder="" style="margin-top: 7px;">
                            </div>
                        </div>
